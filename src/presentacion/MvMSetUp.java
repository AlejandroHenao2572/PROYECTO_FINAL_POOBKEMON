...
public class MvMSetUp extends JFrame {
    ...
    private void crearPanelMaquina1() {
        ...
        JLabel titulo = new JLabel("Máquina 1", SwingConstants.CENTER);
        ...
        // Selección aleatoria de 6 pokemones para la máquina 1
        ...
        JLabel equipoLabel = new JLabel("Equipo de la máquina 1:");
        ...
        // Items de la máquina 1: 2 de cada uno, excepto Revive (1)
        itemsMaquina1.clear();
    ...
    private void crearPanelMaquina2() {
        ...
        JLabel titulo = new JLabel("Máquina 2", SwingConstants.CENTER);
        titulo.setOpaque(true);
        ...
        // Selección aleatoria de 6 pokemones para la máquina 2
        ...
        JLabel equipoLabel = new JLabel("Equipo de la máquina 2:");
        equipoLabel.setFont(new Font("Pokemon GB", Font.BOLD, 14));
        equipoPanel.add(equipoLabel, BorderLayout.NORTH);
        ...
        // Items de la máquina 2: 2 de cada uno, excepto Revive (1)
        itemsMaquina2.clear();
        for (String item : itemsDisponibles) {
        ...
        iniciar.addActionListener((ActionEvent e) -> {
            // Llama a tu método para iniciar la batalla MvM
